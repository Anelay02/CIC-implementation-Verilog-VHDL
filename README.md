...
The Python (version 3.14 was used) model additionally needs :
...
- **Interpolator** — The combs run first at the **low** rate, the
  signal is **zero-stuffed** by `R`, and the integrators run at the **high** rate.

The parameter `CONFIG` selects which of the two configurations is `generated`.
